    ...
    <section id="start" className="py-20 sm:py-24">
      <div className="section-shell">
        <motion.div
          ...
          className="overflow-hidden rounded-[8px] bg-[#06251b] p-8 text-white shadow-[0_28px_70px_rgba(6,37,27,0.24)] sm:p-12 lg:p-14"
        >
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            <div className="max-w-3xl">
              ...
              <p className="text-pretty mt-5 text-lg leading-8 text-white/72">{copy.description}</p>
            </div>
